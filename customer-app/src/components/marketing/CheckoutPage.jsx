              ...
              <div className="border-t border-gray-200 pt-4 space-y-2">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-gray-900">
                    ${price}/{billingCycle === 'monthly' ? 'mo' : 'mo'}
                  </span>
                </div>
                <div className="flex justify-between">
            ...
            {useStripe ? (
              <div className="space-y-6 text-center py-8">
                ...
                <p className="text-gray-600 max-w-md mx-auto">
                  You’ll be redirected to our secure Stripe checkout to complete your purchase. This
                  keeps your payment details safe and compliant.
                </p>
                <p className="text-sm text-gray-500">
                  If you’re not redirected automatically, please check your network and try again.
                </p>
                {loading && (
