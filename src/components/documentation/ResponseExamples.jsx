  ...
  return (
    <Box>
      <Tabs value={activeTab} onChange={(_, val) => setActiveTab(val)} sx={{ mb: 2 }}>
        <Tab icon={<SuccessIcon color="success" />} label="Success Response" iconPosition="start" />
        <Tab icon={<ErrorIcon color="error" />} label="Error Response" iconPosition="start" />
      </Tabs>
              ...
              <Table size="small">
                ...
                <TableBody>
                  {(metadata.errorHandling.errorCodes || []).map(code => (
                    <TableRow key={code}>
                      <TableCell>
                        <Chip label={code} size="small" color="error" variant="outlined" />
                      </TableCell>
                      <TableCell>
                        <Chip
                      ...
                      <TableCell>Standard SQL Server error</TableCell>
                    </TableRow>
                  ))}
                </TableBody>
              </Table>
