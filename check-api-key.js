const prismaService = require('./server/services/prismaService');
        ...
        if (service) {
          ...
          const hasPermission = app.defaultRole?.permissions?.some(perm => {
            const matches = (
              ...
              (perm.objectName === 'api_ContactsGet' || perm.objectName === '/proc/api_ContactsGet') &&
              perm.actions &&
              perm.actions['GET']
            );
            ...
            if (matches) {
              ...
              console.log('❌ No match:', {
                ...
                objectNameMatch: perm.objectName === 'api_ContactsGet' || perm.objectName === '/proc/api_ContactsGet',
