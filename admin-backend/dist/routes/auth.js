 ...
 * @access Private
 */
router.put('/password', adminAuth_1.authenticateAdmin, authController_1.AuthController.changePasswordValidation, (0, adminAuth_1.auditAction)('change_password'), authController_1.AuthController.changePassword);
