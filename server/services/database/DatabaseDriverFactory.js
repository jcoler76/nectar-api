...
class DatabaseDriverFactory {
  ...
  static _validateSDKAvailability(databaseType) {
    const sdkRequirements = {
      ...
      AWS_RDS_POSTGRESQL: '@aws-sdk/client-rds',
      AWS_RDS_MYSQL: '@aws-sdk/client-rds',
      AWS_RDS_MSSQL: '@aws-sdk/client-rds',
      AWS_RDS_ORACLE: '@aws-sdk/client-rds',
      AWS_AURORA_POSTGRESQL: '@aws-sdk/client-rds',
      AWS_AURORA_MYSQL: '@aws-sdk/client-rds',
