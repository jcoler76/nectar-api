...
serviceSchema.index({ createdBy: 1 }); // Index for user-specific queries
serviceSchema.index({ name: 1 }); // Index for name lookups
serviceSchema.index({ isActive: 1 }); // Index for active/inactive filtering
serviceSchema.index({ connectionId: 1 }); // Index for connection lookups
serviceSchema.index({ createdBy: 1, isActive: 1 }); // Compound index for common queries
